...
TreasureHunter.PlayLevel.prototype = {
    ...
    update: function () {
		...
		//var titleLabel = this.add.bitmapText(this.world.centerX, 65, 'eightbitwonder', 'SCORE '+ score, 32);
	...
	scoreplay: function(){
	titleLabel = this.add.bitmapText(this.world.centerX, 65, 'eightbitwonder', '', 32);
        titleLabel.anchor.set(0.5);
		titleLabel = this.add.bitmapText(this.world.centerX, 65, 'eightbitwonder', 'SCORE '+ score, 32);
        titleLabel.anchor.set(0.5);
	},
